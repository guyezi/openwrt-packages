...
m = Map(config, translate('甜糖星愿自动采集'), translate('可以帮你每日自动收取甜糖心愿的星愿，并且可以指定日期每周自动提现!'))
...
if (isLogin) then
    ...
    o:value('Monday', translate('Monday'))
    o:value('Tuesday', translate('Tuesday'))
    o:value('Wednesday', translate('Wednesday'))
    o:value('Thursday', translate('Thursday'))
    o:value('Friday', translate('Friday'))
    o:value('Saturday', translate('Saturday'))
    o:value('Sunday', translate('Sunday'))
    o.default = 'Thursday'
